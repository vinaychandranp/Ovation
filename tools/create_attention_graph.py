...
# heatmap = ax.pcolor(attention[94,::-1,:length], cmap=plt.cm.Blues, alpha=0.9)

dummy = attention[id,::-1,:length]
heatmap = ax.pcolor(dummy, cmap=plt.cm.Blues, alpha=0.9)
